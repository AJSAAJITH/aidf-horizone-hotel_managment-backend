...
var createEmberdding = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var emberdingModels, vectorIndex, hotels, docs, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                emberdingModels = new openai_1.OpenAIEmbeddings({
                    model: "text-embedding-ada-002",
                    apiKey: process.env.OPENAI_API_KEY
                });
                vectorIndex = new mongodb_1.MongoDBAtlasVectorSearch(emberdingModels, {
