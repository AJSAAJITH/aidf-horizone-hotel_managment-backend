...
var createBooking = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var booking, userId, bookingData, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                userId = (_a = req === null || req === void 0 ? void 0 : req.auth) === null || _a === void 0 ? void 0 : _a.userId;
...
var getAllBookingsForHotel = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var hotelId, bookings, bookingWithUser, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all(bookings.map(function (el) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    user = _a.sent();
                                    return [2 /*return*/, { _id: el._id, hotelId: el.hotelId, checkIn: el.checkIn, checkOut: el.checkOut, roomNumber: el.roomNumber, user: { id: user.id, firstName: user === null || user === void 0 ? void 0 : user.firstName, lastName: user === null || user === void 0 ? void 0 : user.lastName } }];
                            }
                        });
                    }); }))];
            case 3:
            ...
            case 4:
                error_3 = _a.sent();
                console.error("Error fetching bookings:", error_3);
